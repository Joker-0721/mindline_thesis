...
根据式\eqref{eq:mindlin-displacement}的位移场、式\eqref{eq:inplane-strain}与式\eqref{eq:transverse-shear-strain}的应变-位移关系以及式\eqref{eq:shear-constitutive}的材料本构，板的动能变分为：
\begin{equation}
